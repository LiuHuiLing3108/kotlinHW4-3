package com.example.kotlinhwlab7_2
...
class MainActivity : AppCompatActivity() {
    ...
    val btn_boy = findViewById<RadioButton>(R.id.btn_boy)
    val btn_girl = findViewById<RadioButton>(R.id.btn_girl)
    ...
    val ll_progress =findViewById<LinearLayout>(R.id.ll_progress)
